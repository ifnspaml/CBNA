...
from models.cbna.cbna import UBNA
from models.cbna_vgg.cbna import UBNAVGG
...
class StateManager(object):
    def __init__(self, model_name, device, model_type, num_layers, num_layers_vgg, cbna_bn_inference,
        ...
        self._init_training()
        self._init_model(
            model_type, num_layers, weights_init, cbna_bn_inference
        )
    ...
    def _init_model(self, model_type, num_layers, weights_init, cbna_bn_inference):
        ...
        model = ubna(
            num_layers, weights_init, cbna_bn_inference
        )
