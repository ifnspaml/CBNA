...
class UBNACommon(nn.Module):
    def __init__(self, num_layers, pretrained, cbna_bn_inference):
        ...
        self.encoder = networks.ResnetEncoder(num_layers, pretrained, cbna_bn_inference)
...
class UBNA(nn.Module):
    ...
    def __init__(self, num_layers=18, weights_init='pretrained', cbna_bn_inference=False):
        super().__init__()
        ...
        self.common = UBNACommon(
            num_layers, pretrained, cbna_bn_inference
        )
