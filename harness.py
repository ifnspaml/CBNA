...
# Local imports
import loaders, loaders.segmentation, loaders.online
...
class Harness(object):
    ...
    def _init_log_dir(self, opt):
        log_base = "pretrained"
        self.log_path = os.path.join(log_base, opt.model_name)
    ...
    def _init_state(self, opt):
        self.state = StateManager(
            opt.model_name, self.device, opt.model_type, opt.model_num_layers, opt.model_num_layers_vgg,
            opt.model_cbna_bn_inference, opt.train_weights_init, opt.train_learning_rate,
